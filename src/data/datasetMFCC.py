...
def create_dataset(config: dict, split: Split) -> SpeechCommandsMFCCDataset:
    data_cfg = config["data"]
    return SpeechCommandsMFCCDataset(
        root=data_cfg["root"],
        split=split,
...
def create_datasets(
    config: dict,
) -> tuple[SpeechCommandsMFCCDataset, SpeechCommandsMFCCDataset, SpeechCommandsMFCCDataset]:
    return (
